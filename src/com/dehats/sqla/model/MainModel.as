...
public class MainModel extends EventDispatcher {
    ...
    public var tableRecords:ArrayCollection = new ArrayCollection();
    ...
    public function updateRecord(pTable:SQLTableSchema, pOriginal:Object, pVo:Object):Object {
        var i:int = tableRecords.source.indexOf(pOriginal);
    ...
    public function refreshRecords(pTable:SQLTableSchema):void {
        if (pTable != null)
            tableRecords.source = db.getTableRecords(pTable);
        else
            tableRecords.removeAll();
    }
